...
all_suites = {
    ...
    "changing_cv": BenchmarkConfig(
        ...
        cv=[
            ...
            6,
            8,
        ],  # The coefficient of variation for gamma distributed intervals
    ),
...
def get_all_suites(model_paths, seed):
    ...
    for exp in all_suites:
        ...
        for req_rate, cv, alpha in itertools.product(
            benchmark_config.req_rate, benchmark_config.cv, benchmark_config.alpha
        ):
